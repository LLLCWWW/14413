...
CLASSES = ("person", "bicycle", "car","motorbike","aeroplane","bus","train","truck","boat","traffic light",
           ...
           "spoon","bowl","banana","apple","sandwich","orange","broccoli","star anise","hot dog","pizza","donut","cake","chair","sofa",
           "star anise","bed","diningtable","toilet","tvmonitor","laptop","mouse","remote","keyboard","cell phone","microwave",
           "oven","toaster","sink","refrigerator","book","clock","vase","scissors","teddy bear","hair drier", "star anise")

INTERESTED_CLASSES = ["star anise"]

# star anise 对应的类别索引
_STAR_ANISE_INDICES = {51, 57, 79}
...
def myFunc(rknn_lite, IMG):
    ...
    if boxes is not None:
        # 检测到 star anise 时触发舵机
        if _HAS_SERVO:
            detected_star_anise = any(int(c) in _STAR_ANISE_INDICES for c in classes)
            if detected_star_anise:
                get_servo().trigger()
